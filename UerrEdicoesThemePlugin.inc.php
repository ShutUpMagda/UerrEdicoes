...
/**
 * @file plugins/themes/UerrEdicoes/UerrEdicoesThemePlugin.inc.php
 *
 * Copyright (c) 2014-2021 Simon Fraser University
 * Copyright (c) 2003-2021 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class UerrEdicoesThemePlugin
...
class UerrEdicoesThemePlugin extends ThemePlugin {
	/**
	...
	public function init() {
		...
		$this->addOption('typography', 'FieldOptions', [
			'type' => 'radio',
			'label' => __('plugins.themes.UerrEdicoes.option.typography.label'),
			'description' => __('plugins.themes.UerrEdicoes.option.typography.description'),
			'options' => [
				[
					'value' => 'notoSans',
					'label' => __('plugins.themes.UerrEdicoes.option.typography.notoSans'),
				],
				[
					'value' => 'notoSerif',
					'label' => __('plugins.themes.UerrEdicoes.option.typography.notoSerif'),
				],
				[
					'value' => 'notoSerif_notoSans',
					'label' => __('plugins.themes.UerrEdicoes.option.typography.notoSerif_notoSans'),
				],
				[
					'value' => 'notoSans_notoSerif',
					'label' => __('plugins.themes.UerrEdicoes.option.typography.notoSans_notoSerif'),
				],
				[
					'value' => 'lato',
					'label' => __('plugins.themes.UerrEdicoes.option.typography.lato'),
				],
				[
					'value' => 'lora',
					'label' => __('plugins.themes.UerrEdicoes.option.typography.lora'),
				],
				[
					'value' => 'lora_openSans',
					'label' => __('plugins.themes.UerrEdicoes.option.typography.lora_openSans'),
				],
			],
			'default' => 'notoSans',
		]);
		$this->addOption('useHomepageImageAsHeader', 'FieldOptions', [
			'label' => __('plugins.themes.UerrEdicoes.option.useHomepageImageAsHeader.label'),
			'description' => __('plugins.themes.UerrEdicoes.option.useHomepageImageAsHeader.description'),
				'options' => [
				[
					'value' => true,
					'label' => __('plugins.themes.UerrEdicoes.option.useHomepageImageAsHeader.option')
				],
			],
			'default' => false,
		]);
		...
		$this->addOption('baseColour', 'FieldColor', [
			'label' => __('plugins.themes.UerrEdicoes.option.colour.label'),
			'description' => __('plugins.themes.UerrEdicoes.option.colour.description'),
			'default' => '#1E6292',
		]);
		...
		$this->addScript('slideshow', 'js/slideShow.js');
	...
	function getDisplayName() {
		return __('plugins.themes.UerrEdicoes.name');
	}
	...
	function getDescription() {
		return __('plugins.themes.UerrEdicoes.description');
	}
}
